...
export const { setSiteSettings, setSiteSettingsLoading, setSiteSettingsError } =
...
export const updateSiteSettings = (data) => async (dispatch) => {
  dispatch(setSiteSettingsLoading(true));
  try {
    const res = axiosInstance.put("/site-settings", data, {
